...
1. You're viewing a folder in bucketbrowser (cached for 1 minute)
2. You add a file `new-file.txt` via AWS Console
3. **In bucketbrowser**: The file won't appear immediately
...
2. You're viewing that folder in bucketbrowser
